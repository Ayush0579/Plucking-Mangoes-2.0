...
function setup() {
  ...
  ground = new Ground(0,680,4000,50);
	boy = new Boy(250,580);
...
function draw() {
  ...
  fill("black");
  textSize(20);
  text("N.B.-> This is a new version of the same project. I worked on it by using another user's project as a reference",550,20);
}
